...
class TitleConfiguration(models.Model):
    ...
    subchapters = models.TextField(
        blank=True,
        help_text="A comma-separated list of subchapters to parse. All parts within the listed subchapters will be included. E.g., \"IV-C, IV-D, IV-F\" or simply \"IV-C\".",
    ...
    parts = models.TextField(
        blank=True,
        help_text="A comma-separated list of individual parts to parse if you do not wish to include the entire subchapter. E.g., \"400, 457, 460\" or simply \"400\".",
        validators=[RegexValidator(
            regex="^(\d+)(,\s*\d+)*$",
