...
/**
 * Hello World API Stack implementation
...
export class HelloWorldStack extends BaseStack {
  ...
  private createLambdaFunction(): void {
    const role = new iam.Role(this, 'LambdaRole', {
      roleName: this.getResourceName('role', 'hello'),
    ...
    this.lambdaFunction = new lambda.Function(this, 'HelloWorldFunction', {
      functionName: this.getResourceName('function', 'hello'),
  ...
  private createApiGateway(): void {
    this.api = new apigateway.RestApi(this, 'HelloWorldApi', {
      restApiName: this.getResourceName('api', 'hello'),
      description: 'Hello World API Service',
      deployOptions: {
  ...
  private addOutputs(): void {
    if (this.lambdaFunction) {
      new cdk.CfnOutput(this, 'LambdaArn', {
        ...
        exportName: `${this.stackPrefix}-hello-lambda-arn`,
      });
    }
    ...
    if (this.api) {
      new cdk.CfnOutput(this, 'ApiUrl', {
        value: this.api.url,
        description: 'Hello World API Gateway URL',
        exportName: `${this.stackPrefix}-hello-api-url`,
      });
    }
  }
}
