...
urlpatterns = [
    ...
    path("v2/", include([
        ...
        path("title/<int:title>/part/<name>", PartsView.as_view()),
        path("<date>", EffectiveTitlesView.as_view()),
        path("<date>/title/<int:title>", EffectivePartsView.as_view()),
        path("<date>/title/<int:title>/part/<name>", EffectivePartView.as_view()),
        path("<date>/title/<int:title>/part/<name>/toc", EffectivePartTocView.as_view()),
        path("title/<int:title>/existing", ExistingPartsView.as_view()),
    ])),
    path("v3/", include([
