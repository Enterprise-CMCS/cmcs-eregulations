...
#
# TEST_USERNAME = os.environ.get('TEST_USER', 'default_test_user')
# TEST_PASSWORD = os.environ.get('TEST_PASSWORD', 'default_test_password')
#
#
# class EditContentViewTest(unittest.TestCase):
#     def setUp(self):
#         # Create a user for authentication
#         self.user = User.objects.get_or_create(username=TEST_USERNAME, defaults={'password': TEST_PASSWORD})
#         self.client = Client()
#
