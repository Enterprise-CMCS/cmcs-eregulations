...
S3_AWS_SECRET_ACCESS_KEY = os.environ.get("FILE_MANAGER_AWS_SECRET_ACCESS_KEY", default=None)
...
DEFAULT_FILE_STORAGE = 'file_manager.storage_backends.PublicMediaStorage'
