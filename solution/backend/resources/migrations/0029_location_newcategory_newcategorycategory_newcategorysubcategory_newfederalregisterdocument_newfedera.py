# Generated by Django 3.2.18 on 2023-03-15 16:21

import django.core.validators
from django.db import migrations, models
import django.db.models.deletion
import django_jsonform.models.fields
import resources.new_models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('title', 'part', 'subpart'), ('title', 'part', 'section')},
            },
        ),
        migrations.CreateModel(
            name='NewCategory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_sort', resources.new_models.NaturalSortField('name', db_index=True, editable=False, max_length=255, null=True)),
                ('description_sort', resources.new_models.NaturalSortField('description', db_index=True, editable=False, max_length=255, null=True)),
