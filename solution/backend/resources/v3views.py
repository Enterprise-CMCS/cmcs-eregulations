...
class ResourceExplorerViewSetMixin(OptionalPaginationMixin, LocationFiltererMixin):
    PARAMETERS = [
        ...
        OpenApiQueryParameter("sort", "Sort results by this field. Valid values are \"newest\", \"oldest\", and \"relevance\". Newest is the default, and relevance requires a search query.", str, False),
