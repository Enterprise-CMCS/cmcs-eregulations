...
from resources.models import AbstractPublicResource
...
class SupplementalContentView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            content = AbstractPublicResource.objects.all().select_subclasses().get(id=content_id, approved=True)
            c = {
            ...
            return {**context, **c}
        except AbstractPublicResource.DoesNotExist:
            raise Http404
